...
function confirmNumber() {
    ...
    if (phoneNumber.charAt(0) === '0') { phoneNumber = phoneNumber.substr(1);}
    ...
    if (phoneNumber == "") {
        ...
        function focusNumberLenght() { mainView.router.load({ pageName: 'smscode' }); }
    }
            ...
            if (platform == 'Android') {
                window.FirebasePlugin.verifyPhoneNumber(phoneNumberFull, 60, function (credential) {
                    ...
                    if (countSMSInicio >= 2) {
                        ...
                        function errorSmsCode() { $('#otherLoginInicio').show(); }
                    } else {
                        myApp.alert(
                        ...
                        function errorSmsCode() { return false; }
                    }
                });
            }
            else {
