...
myApp.onPageInit('home', function (page) {
    // 2018-12-11 - SHADOW : MODIFIED
    $('body').addClass('green-white');
...
function builderNewsHomeDetails() {
    ...
    if (newsListHome.length == 0) {
        ...
        $.each(newsListHome, function (i, item) {
            ...
            if (item.tipoObjeto == "banner") {
                ...
                strBuilderLastNewsContent.push('<div class="chip chipHomeTags"><div class="media"><i class="fa fa-futbol"></i></div><div class="chip-label chipHomeSportLabel">Futbol Primera</div></div>');
                strBuilderLastNewsContent.push('<div class="chip chipHomeDate"><div class="media"><i class="fa fa-newspaper"></i></div><div class="chip-label chipHomeDateLabel">' + formatDateSucesos(item.fecha.fecha) + '</div></div>');
                ...
                strBuilderLastNewsContent.push('<div class="row"><div class="col-100"><div class="color-gray homeCardcontent">' + noticiaTruncada + '</div></div>');
                strBuilderLastNewsContent.push('<div class="row"><div class="col-50"><div class="">' + item.titulo + '</div></div>');
                strBuilderLastNewsContent.push('<div class="col-50"><div class="dateTitleNew color-gray"><i class="fa fa-clock"></i>' + '15/09/2018' + '</div></div></div></div>');
                ...
                strBuilderLastNewsContent.push('<div id="tournament-matches-header" class="card-header no-border"><div id="tournament-match-prefix">');
                strBuilderLastNewsContent.push('<div class="tournament-matches-icon"><img data-src=' + item.torneo.organizador.imagenPrincipalMin + ' class="lazy lazy-fadeIn img-shield-tournament" ></div><div id="tournament-match-name-division">');
                ...
                strBuilderLastNewsContent.push('<div class="card-footer tournament-matches-footer">');
                if (item.vivo == "true") {
                    strBuilderLastNewsContent.push('<div class="tournament-matches-matchday-live animated infinite pulse">EN VIVO</div>');
                } else {
                    strBuilderLastNewsContent.push('<div class="tournament-matches-matchday">' + item.fechaEncuentro.fecha + '</div>');
                }
                strBuilderLastNewsContent.push('Ver más...</div></a></div>');
                strBuilderLastNewsContent.push('</div></div>');
                ...
                strBuilderLastNewsContent.push('<div class="chipHomeContainer">');
                //strBuilderLastNewsContent.push('<a onclick="loadNewDetails('+item.id+')" href="#" class="item-link item-content">');
                strBuilderLastNewsContent.push('<div class="chip chipHomeCategory"><div class="media"><i class="fa fa-futbol"></i></div><div class="chip-label chipHomeCategoryLabel">Liga Totorense</div></div>');
                strBuilderLastNewsContent.push('<div class="chip chipHomeTags"><div class="media"></div><div class="chip-label chipHomeSportLabel">El canducho</div></div>');
                strBuilderLastNewsContent.push('<div class="chip chipHomeDate"><div class="media"><i class="fa fa-newspaper"></i></div><div class="chip-label chipHomeDateLabel">' + formatDateSucesos(item.fecha.fecha) + '</div></div>');
                strBuilderLastNewsContent.push('</div></div>');
                strBuilderLastNewsContent.push('<div class="card-content news-content">');
    ...
    console.log(item);*/
                ...
                strBuilderLastNewsContent.push('<div id="tournament-matches-header" class="row card-header no-border">');

                strBuilderLastNewsContent.push('<div class="col-100 tournament-header-titulo">' + item.titulo + '</div>');
                strBuilderLastNewsContent.push('<div class="col-100 tournament-header-fecha">' + item.titulo + '</div>');
                ...
                strBuilderLastNewsContent.push('<div id="tournament-matches-header" class="card-header no-border"><div id="tournament-match-prefix">');
                strBuilderLastNewsContent.push('<div class="tournament-matches-icon"><img data-src="img/icon-shield-default.png" class="lazy lazy-fadeIn img-shield-tournament" ></div><div id="tournament-match-name-division">');
                ...
                strBuilderLastNewsContent.push('<div class="tournament-matches-matchday">' + item.nombre + '</div></div></div></div>');
                strBuilderLastNewsContent.push('<div class="card-content tournament-matches-content">');
                strBuilderLastNewsContent.push('<div class="card-content-inner">');
                var verMasFecha = false;
    ...
    $.each(homeDetails2List.calendario, function (i, item) {
        ...
        if (item.fechaOcurrencia.fecha == eventDay) {
            ...
            if (item.tipoObjeto == "evento") {
                ...
                strBuilderCalendarContent.push('<div class="timeline-item row">');
                strBuilderCalendarContent.push('<div class="timeline-item-date col-100">' + dateTimeLineEventsSplitedFormat(item.fechaOcurrencia.fecha, 0) + ' <span style="font-weight: bold;">' + dateTimeLineEventsSplitedFormat(item.fecha.fecha, 1) + '</span></div>');
                // strBuilderCalendarContent.push('<div class="timeline-item-divider col-100"></div>');
                strBuilderCalendarContent.push('<div class="timeline-item-content card" id="cardHomeTimeLine">');

                // strBuilderCalendarContent.push('<div style="width: 60px; background: blue; height: 60px"></div>');
                strBuilderCalendarContent.push('<a href="#" class="aEventDetails" onclick="loadEventDetails1(' + item.id + ',' + true + ')" style="flex: auto;">');
                strBuilderCalendarContent.push('<div class="card card-event-home col-100">');
                ...
                $('#calendarEventsView').html("");
                console.log(item);
                if (item == "") { strBuilderCalendarContent.push(''); }
                else {
                    idLiveMatchSportDetails = null;
                    strBuilderCalendarContent.push('<div class="timeline-item row">');
                    strBuilderCalendarContent.push('<div class="timeline-item-date col-100">' + dateTimeLineEventsSplitedFormat(item.fechaEncuentro.fecha, 0) + ' <span style="font-weight: bold;">' + dateTimeLineEventsSplitedFormat(item.fechaEncuentro.fecha, 1) + '</span></div>');
                    // strBuilderCalendarContent.push('<div class="timeline-item-divider col-100"></div>');
                    strBuilderCalendarContent.push('<div class="card card-event-home col-100">');
                    strBuilderCalendarContent.push('<div class="timeline-item-content card" id="cardHomeTimeLine">')
                    ...
                    strBuilderCalendarContent.push('<div class="row item-content">');

                    strBuilderCalendarContent.push('<div class="row" id="row-lastmatch-tournament-calendar">');
                    ////strBuilderCalendarContent.push('<div class="col-100 col-lastmatch-tournament col-lastmatch-tournament-middle">');
                    strBuilderCalendarContent.push('<div class="col-100 col-lastmatch-tournament-nametournament">' + item.torneo.deporteCategoria.nombreCorto + '</div>');
                    strBuilderCalendarContent.push('</div>');
                    // strBuilderCalendarContent.push('<div class="col-lastmatch-tournament-team">' + item.local.nombre + '</div>');
                    strBuilderCalendarContent.push('<div class="row" style="display:flex">');
                    strBuilderCalendarContent.push('<div class="col-lastmatch-tournament col-lastmatch-tournament-middle" style="flex:3">');
                    ...
                    strBuilderCalendarContent.push('<div class="col-lastmatch-tournament-result" style="margin: auto; flex: 2;"><p>VS</p></div>');

                    strBuilderCalendarContent.push('<div class="col-lastmatch-tournament" style="flex: 3;">');
                    strBuilderCalendarContent.push('<div style="flex: auto;"></div>');
                    strBuilderCalendarContent.push('<div class="col-lastmatch-tournament-shield"><img data-src="img/icon-shield-default.png" class="lazy lazy-fadeIn img-shield-lastmatch" /></div>');
                    strBuilderCalendarContent.push('</div>');
                    strBuilderCalendarContent.push('</div>');
                    strBuilderCalendarContent.push('</div>');

                    strBuilderCalendarContent.push('<div class="row" id="timeline-inner-timepanel">');
...
function builderTimeLineEventsHome() {
    ...
    $.each(homeDetails2List.calendario, function (i, item) {
        if (item.tipoObjeto == 'evento') {
            ...
            strBuilderTimeLineContent.push('<div class="timeline-item row">');
            strBuilderTimeLineContent.push('<div class="timeline-item-date col-100">' + dateTimeLineEventsSplitedFormat(item.fecha.fecha, 0) + ' <span style="font-weight: bold;">' + dateTimeLineEventsSplitedFormat(item.fecha.fecha, 1) + '</span></div>');
            // strBuilderTimeLineContent.push('<div class="timeline-item-divider col-100"></div>');
            strBuilderTimeLineContent.push('<a href="#" class="aEventDetails" onclick="loadEventDetails1(' + item.id + ',' + true + ')" style="width: 100%;">');
            strBuilderTimeLineContent.push('<div class="card card-event-home col-100">');
            strBuilderTimeLineContent.push('<div class="timeline-item-content card" id="cardHomeTimeLine">');

            // strBuilderTimeLineContent.push('<div style="width: 60px; background: blue; height: 60px"></div>');
            ...
            if (item == "") {
                ...
                strBuilderTimeLineContent.push('<div class="timeline-item row">');
                strBuilderTimeLineContent.push('<div class="timeline-item-date col-100">' + dateTimeLineEventsSplitedFormat(item.fechaEncuentro.fecha, 0) + ' <span style="font-weight: bold;">' + dateTimeLineEventsSplitedFormat(item.fechaEncuentro.fecha, 1) + '</span></div>');
                // strBuilderTimeLineContent.push('<div class="timeline-item-divider col-100"></div>');
                strBuilderTimeLineContent.push('<div class="card card-event-home col-100">');
                strBuilderTimeLineContent.push('<div class="timeline-item-content card" id="cardHomeTimeLine">');


                strBuilderTimeLineContent.push('<div style="width: 60px; background: blue; height: 60px">342wer</div>');
                ...
                strBuilderTimeLineContent.push('<div class="row item-content">');
                strBuilderTimeLineContent.push('<div class="col-100 ">');
                ...
                strBuilderTimeLineContent.push('<div class="col-lastmatch-tournament">');
                ...
                strBuilderTimeLineContent.push('</div>');
                strBuilderTimeLineContent.push('<div class="col-lastmatch-tournament col-lastmatch-tournament-middle">');
                ...
                strBuilderTimeLineContent.push('<div class="row" id="match-datetime">');
