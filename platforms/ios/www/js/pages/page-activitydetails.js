...
function builderNewsActivityDetails() {
	...
	if (recentNewsListActivityDetails.length == 0) {
		...
		$.each(recentNewsListActivityDetails, function (i, item) {
				...
				strBuilderNewsActivityDetailsContent.push('<div class="card demo-card-header-pic"><div style="background-image:url(' + item.imagenPrincipalMin + ');" valign="bottom" class="card-header color-white no-border">');
				...
				strBuilderNewsActivityDetailsContent.push('<div class="row"><div class="col-100"><div class="color-gray homeCardcontent">' + item.detalle + '</div></div>');
				strBuilderNewsActivityDetailsContent.push('<div class="row"><div class="col-50"><div class="">' + item.titulo + '</div></div>');
				strBuilderNewsActivityDetailsContent.push('<div class="col-50"><div class="dateTitleNew color-gray">15/09/2018</div></div></div>');
				strBuilderNewsActivityDetailsContent.push('<div class="col-50"><div class="dateTitleNew color-gray"><i class="fa fa-clock"></i>' + '15/09/2018' + '</div></div></div></div>');
				...
				strBuilderNewsActivityDetailsContent.push('<div class="card-footer tournament-matches-footer">');
				if (item.vivo == "true") {
					strBuilderNewsActivityDetailsContent.push('<div class="tournament-matches-matchday-live animated infinite pulse">EN VIVO</div>');
				} else {
					strBuilderNewsActivityDetailsContent.push('<div class="tournament-matches-matchday">' + item.fechaEncuentro.fecha + '</div>');
				}
				strBuilderNewsActivityDetailsContent.push('Ver más...</div></a></div>');
				strBuilderNewsActivityDetailsContent.push('</div></div>');
				...
				strBuilderNewsActivityDetailsContent.push('<div id="tournament-matches-header" class="row card-header no-border">');

				strBuilderNewsActivityDetailsContent.push('<div class="col-100 tournament-header-titulo">' + item.titulo + '</div>');
				strBuilderNewsActivityDetailsContent.push('<div class="col-100 tournament-header-fecha">' + item.titulo + '</div>');
